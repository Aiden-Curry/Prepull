...
import { eraFuryCuratedProfile, referenceSlots } from "../lib/curated-gear/data.ts";
...
export const curatedReferenceProfiles = recommendationRegistry.map((entry) => entry.profile);
...
export { authoringHeaders, eraFuryCuratedProfile, referenceSlots, rowsToCsv };
