...
export type RaidAssignment = { id: string; characterId: string; characterIds?: string[]; label: string; detail?: string; category?: string; section?: string; sectionPosition?: number; position?: number };
